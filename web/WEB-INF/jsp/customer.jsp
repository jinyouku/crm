			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" id="edit_customer_form">
						...
						<div class="form-group">
							<label for="edit_customerFrom" style="float:left;padding:7px 15px 0 27px;">客户00来源</label>
							<div class="col-sm-10">
		...
		$(function () {
			$.ajax({
				...
				success : function (data) {
					alert(data.fromType[0].dict_item_name);
					var fromType =
					...
					$.each(data.fromType ,
							function (i,n) {
						var id = n.dict_id;
								$("#customerFrom").append("<option value='id'<c:if test="id == custSource"> selected</c:if>>"+n.dict_item_name+"</option>");
							});
